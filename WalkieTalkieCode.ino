/*
  FILENAME:   WalkieTalkieCode.ino
  AUTHOR:     Chris Murray
  CONTACT:    cdmurray08@gmail.com
  
  DESCRIPTION
  Simple example for creating a walkie talkie by sending audio
  using the nRF24L01 RF transceiver module.
  This code enables multiple private channels to operate simultaneously in the same vicinity. 
  ...
  Original code written by Orlando S. Hoilett, orlandohoilett@gmail.com
...
//int radioID = ???;   //replace question marks with your radio identifier, 0-128
